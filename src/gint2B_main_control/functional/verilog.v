...
module main_controlB(input clk,
  input rst,
  input CS1,
  input SDI1,
  input clk2,
...
wire unsat;
wire [63:0] variable_mask, randVar_sel_l0, Var_to_flip, arbiter_input, HVar_Notin_Refr, GVar_Notin_Refr, allVar_Notin_Refr, candVar_G, candVar_H;
