...
generate 
    ...
    for (n2=0; n2<1; n2=n2+1) begin
        routing_node UUT_routing_nodes_l2 (clk,rst,Dout_l1[22+46*n2:46*n2],Dout_l1[22+46*n2+23:46*n2+23],Dout_l2[20+23*n2:23*n2+5],PRNG[2+n2],RND,Aout_l2[15+32*n2:32*n2],Aout_l2[15+32*n2+16:32*n2+16],Dout_l2[22+23*n2:23*n2]);
    end
