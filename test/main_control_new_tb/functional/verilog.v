...
module main_control_new_tb ();
 
  parameter CLOCK_PERIOD_NS1 = 10;
  parameter CLOCK_PERIOD_NS2 = 10;
 ...
 main_control_new UUT (clk,rst,CS1,SDI1,clk2,START,CS2,WTA_OUT,WTA_VALID,TRUE0,TRUE1,VSAB_OUT,BP_MUX_SAMPLED,BUSY,SDO1,WTA_SEL0,WTA_SEL1,RWLF_pre,RWLB_pre,LIT_SEL,BP_MUX_SEL,DRDN_WBLp,DRUPn_WBLp,DRDN_WBLn,DRUPn_WBLn,WWL_pre,VSAF_EN,VSAB_EN,FP_PUn,BP_PUn,BP_MUX_READY,WTA_EN,RESETn);
  ...
  initial
	...
	$sdf_annotate("/home/tinish/gint1/digital/build/main_control_new/par-rundir/main_control_new.par.sdf", main_control_new_tb.UUT, , , "maximum");
	//$sdf_annotate("/home/tinish/gint1/digital/build/main_control_new/syn-rundir/main_control_new.tt_nominal_max_1p20v_25c.extra_view.sdf", main_control_new_tb.UUT, , , "maximum");
	//$sdf_annotate("/home/tinish/gint1/digital/syn_trial/main_control_new.mapped.sdf", main_control_new_tb.UUT, , , "maximum");
